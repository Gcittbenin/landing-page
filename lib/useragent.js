 ...
 *
 * "headless" is matched as a substring rather than a whole word: the string
 * that actually appears is "HeadlessChrome", which has no boundary after it.
 */
const BOT_RE =
  /headless|\b(?:bot|crawler|spider|crawl|slurp|facebookexternalhit|preview|monitor|curl|wget|python-requests|axios|okhttp)\b/i;
