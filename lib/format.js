...
const EMAIL_ROWS = [
  ...
  ['Appareil', (l) => l.device, true],
  ['Navigateur', (l) => l.browser, true],
  ['Système', (l) => l.os, true],
  ['Écran', (l) => l.screen, true],
  ['Fuseau horaire', (l) => l.timezone, true],
  ['Adresse IP', (l) => l.ip, true],
 ...
 * The form now asks for the two parts separately; splitting `name` is the
 * fallback for a lead recorded before that, or forwarded by another system.
 */
function firstName(lead) {
  if (lead && typeof lead === 'object' && lead.firstName) return lead.firstName;
  const full = lead && typeof lead === 'object' ? lead.name : lead;
      ...
      <table role="presentation" class="wrap" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#ffffff;border-radius:16px;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif">
        ...
        <tr>
          <td class="pad" style="background:#12305c;padding:32px 36px">
            ...
            <div class="h1" style="color:#ffffff;font-size:26px;font-weight:700;line-height:1.3;margin-top:10px">Merci pour votre confiance, ${e(firstName(lead))}.</div>
